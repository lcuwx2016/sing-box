...
- Integration and development releases: `dev-next`

## Policy

- Merge official `testing` updates into `dev-next` after validating them on an `integration/*` branch.
...
- Use GitHub Actions to verify Linux amd64, Windows amd64, Android ARM64, and Android ARMv7 before updating `dev-next`.
